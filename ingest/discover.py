...
REGIONS = [
    # Непокрытые субъекты — проход по каждому: столица и/или название
    # региона. Приграничье и Поволжье искались прошлыми прогонами.
    "Махачкала", "Дагестан", "Грозный", "Чечня", "Ингушетия", "Магас",
    "Владикавказ", "Осетия", "Нальчик", "Кабардино-Балкария",
    "Черкесск", "Элиста", "Калмыкия", "Майкоп",
    "Саранск", "Мордовия", "Йошкар-Ола", "Марий Эл", "Сыктывкар", "Коми",
    "Петрозаводск", "Карелия", "Мурманск", "Архангельск", "Северодвинск",
    "Калининград", "Великий Новгород", "Ленинградская область", "Гатчина",
    "Кострома", "Киров", "Уфа", "Башкортостан", "Башкирия",
    "Курган", "Барнаул", "Алтайский край", "Горно-Алтайск",
    "Кызыл", "Тыва", "Абакан", "Хакасия",
    "Красноярск", "Иркутск", "Улан-Удэ", "Бурятия", "Чита", "Забайкалье",
    "Якутск", "Якутия", "Благовещенск", "Амурская область",
    "Хабаровск", "Владивосток", "Приморье", "Магадан",
    "Южно-Сахалинск", "Сахалин", "Петропавловск-Камчатский", "Камчатка",
    "Биробиджан", "Анадырь", "Чукотка",
    "Сургут", "Ханты-Мансийск", "ХМАО", "Нижневартовск",
    "Салехард", "Новый Уренгой", "ЯНАО", "Ноябрьск", "Нарьян-Мар",
    "Томск", "Кемерово", "Новокузнецк", "Новосибирск",
    "Саха", "Севастополь",
]
