...
- текущая сборка исправляет таким образом 976 имен, включая `Илский` ->
...
Всего текущая сборка исправляет по ОКТМО 1 470 имен. Ещё 24 русских названия
...
принимаются. Итого относительно старой сборки исправлено 1 494 отображаемых
имени; один канонический каталог используется картой, поиском, API и SEO.
