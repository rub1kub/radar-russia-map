  ...
  const slotLoad = useMemo(() => {
    ...
    return slots.map((slot) => {
      ...
      for (const event of historyEvents) {
        ...
        count += 1;
        // Точечные фиксации и перехваты — внутренняя шкала столбиков.
        // Счёт всех событий меряет болтовню эфира: в тихий полдень 97
        // областных тревог и 94 «опасности» давали столбик выше, чем
        // ночной налёт, и пик истории вставал не туда. Числом наружу
        // шкала не выводится — сколько бортов на самом деле, не знает
        // никто, событий всегда меньше.
