        ...
        >
          ...
          <section className="tool-section">
            ...
            <div className="severity-legend">
              <span data-tip="Борт уже видят: фиксация, взрыв, громкие звуки. Это про то, ЧТО сообщили, а не про то, сколько лент это подтвердило">
                <i style={{ background: severityColor(9, 0.95) }} aria-hidden="true" />Фиксация, взрыв, громко
              </span>
