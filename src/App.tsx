        ...
        >
          ...
          <section className="tool-section">
            ...
            <p className="legend-note">
              Цвет тускнеет по скорости борта: район аппарат пересекает за
              полчаса, область — часа за три, и к этому сроку зона гаснет. Ракета
              гаснет вшестеро быстрее дрона. Область целиком закрашивается бледно:
