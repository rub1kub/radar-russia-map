...
export type HistoryDay = {
  ...
  confirmed: number;
  /**
   * Борты над точками: фиксации, перехваты и удары точечных зон. Мера
   * налёта — счёт всех событий меряет болтовню эфира: девяносто семь
   * тревог тихого дня перевешивали полсотни бортов ночного налёта.
   */
  heavy?: number;
  max_severity: number;
