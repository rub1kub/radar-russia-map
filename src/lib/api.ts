...
export type HistoryDay = {
  ...
  confirmed: number;
  /**
   * Точечные фиксации, перехваты и удары — внутренняя шкала полосы дней.
   * Счёт всех событий меряет болтовню эфира: девяносто семь тревог тихого
   * дня перевешивали полсотни фиксаций ночного налёта. Числом наружу не
   * выводится: сколько бортов на самом деле, не знает никто.
   */
  heavy?: number;
  max_severity: number;
