...
const GLYPHS: Record<IconKind, string> = {
  // Квадрокоптер: четыре луча с винтами и корпус.
  uav: `
    <path d="M11 11 L21 21 M21 11 L11 21" stroke="#fff" stroke-width="2" stroke-linecap="round"/>
    <circle cx="10.5" cy="10.5" r="3.1" fill="none" stroke="#fff" stroke-width="1.7"/>
    <circle cx="21.5" cy="10.5" r="3.1" fill="none" stroke="#fff" stroke-width="1.7"/>
    <circle cx="10.5" cy="21.5" r="3.1" fill="none" stroke="#fff" stroke-width="1.7"/>
    <circle cx="21.5" cy="21.5" r="3.1" fill="none" stroke="#fff" stroke-width="1.7"/>
    <rect x="13.6" y="13.6" width="4.8" height="4.8" rx="1.4" fill="#fff"/>`,

  // FPV: тот же корпус, но с камерой — конус вперёд.
  fpv: `
