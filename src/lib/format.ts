...
export const SIGNAL_LABELS: Record<string, string> = {
  ...
  impact: "Взрыв",
  // За этим классом в корпусе почти всегда «Внимание по БПЛА» — раннее
  // предупреждение радарных лент, что борт может прийти. Подпись «Меры
  // безопасности» не значила ничего: она не говорила ни что случилось,
  // ни что делать.
  caution: "Внимание",
