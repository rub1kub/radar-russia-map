...
export const SIGNAL_LABELS: Record<string, string> = {
  ...
  alarm: "Тревога",
  detection: "Фиксация",
  // Что именно сработало по борту, карта не утверждает: словом «громко»
  // сообщают об этом и сами ленты, и решением владельца проекта наружу
  // идёт только наблюдаемое — звук, а не средство.
  intercept: "Громко",
  impact: "Взрыв",
