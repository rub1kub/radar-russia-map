...
export const THREAT_LABELS: Record<string, string> = {
  ...
  bek: "БЭК",
  aviation: "Авиация",
  // Аэропорты и мост: пара «закрыто — открыто» со своим отбоем.
  // Подпись пустая нарочно — сигнал «Инфраструктура» уже сказал всё,
  // и «Инфраструктура · Инфраструктура» читалось бы как заикание.
  infra: "",
  unknown: "Неизвестно"
};
