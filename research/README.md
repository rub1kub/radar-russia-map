...
- Нет геометрий.
- Используется для канонических названий НП и районов. Районы дополнительно
  сопоставляются по субъекту, геометрии и составу населённых пунктов во
  временной БД; все 89 supplemental ADM2 закреплены exact-словарём.
