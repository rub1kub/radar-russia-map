...
@pytest.mark.parametrize("text", [
    ...
    # российские зоны, под «николаев\w*» — 543.
    "Львовская работа МОГ меры предосторожности",
...
@pytest.mark.parametrize("text,signal", [
    ("Козельский район Калужская область Работа ВКС по БПЛА Меры безопасности",
     "caution"),
...
BANDS = {
    ...
    "alarm": (6, 7), "danger": (4, 5), "caution": (0, 3), "infra": (0, 3),
}
