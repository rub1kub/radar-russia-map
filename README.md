...
- доступ в интернет для тайлов OpenFreeMap и Esri.
...
- Основная подложка — label-free векторные стили OpenFreeMap; собственные
  Natural Earth дороги, железные дороги и городские полигоны остаются
  обзорными тематическими слоями, а не полной уличной картой.
